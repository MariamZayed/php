<?php
    ...
    session_start();
    if(!empty($_SESSION))
        header("location:../View/homePage.php? you already logged in! go to home page");
    // else
...
<body>
    <div class="container">
        ...
        <form method="post" action="../Validation/registerValidation.php" enctype="multipart/form-data">
            <div class="mb-3">
